...
ExpPath  = "../../Experiments/Recola_46_3/"
...
models = {
    # "LinTanh": [""],
    # "LinLinTanh": ["128"],
    # "GRUFF": ["128-2-32", "32-1-16", "16-1-8", "64-2-16"],
    # "GRUFF": ["32-1-8"],
    # "FFGRUFF": ["32-2-32"],
    # "LinLinTanhSinc": ["128-50-10"],
    # "Transformer": ["32-1-1", "64-1-1", "128-1-1", "128-4-1", "128-4-2"]
    }
feats = ["FlowBERT_2952h_base_cut30"]#"MFB_standardized", "FlowBERT_2952h_base_cut30", "xlsr_53_56k_cut30"
        ...
        for feat in feats:
            for dataset in datasets:
                ...
                for annot in annots:
                    ...
                    myExp.learningRate = 0.001 # 0.001
                    myExp.maxEpoch = 250
                    myExp.tolerance = 15
                    myExp.minForTolerance = 50 # 50
